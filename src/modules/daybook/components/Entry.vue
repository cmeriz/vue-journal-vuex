<template>
    ...
    >
        ...
        <div class="entry-description">
            ...
            nobis ducimus, consectetur id nam, nulla blanditiis cupiditate
            aspernatur, ea consequuntur placeat! Nam minima, nihil tempora at
            quisquam placeat ea reprehenderit.
        </div>
    </div>
</template>
